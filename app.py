...
if "marker" not in st.session_state: st.session_state.marker = {"lat": 31.6295, "lon": -7.9811}
...
def intro_page():
    ...
    with col1:
        ...
        """)
        st.markdown("### 🎯 Vision")
        st.write("Enable **data-driven agriculture in Morocco**, improving productivity while preserving resources.")
        ...
        - **Precision Farming:** Optimized irrigation and fertilizer strategies.
...
def dashboard_page():
    ...
    if st.sidebar.button("🔄 Refresh Weather"):
        ...
        except: st.warning("Using demo weather data")
